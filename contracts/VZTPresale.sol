...
contract VZTPresale is Ownable, Pausable, HasNoTokens {
    ...
    /** the amount of tokens this presale has credited for each purchaser address */
   ...
   */
    ...
    */
    ...
    /*
      allows the caller to send ether to the Campaign and 
      have the tokens created in an address of their choosing
    */
    function proxyPayment(address buyer) payable public whenNotPaused returns(bool) {
        doPayment(buyer, msg.value);
        return true;
    }
    ...
    */
    ...
    function doPayment(address buyer, uint256 value) internal {
        require(isPresale());
    ...
    */
    ...
    function doRefund(address buyer) internal {
        require(buyer != address(0));
